...
st.header("hello I'm BRaiNWAVE an AI assistant powered by deepseek...@Your service")
...
if prompt:
    ...
    with st.spinner("Cooking up Tasty knowledge"):
        ...
        st.write(response + " And remember BRaiNWAVE wants Mankind to bring on the peace and love in the valley")
