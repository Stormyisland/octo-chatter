...
if prompt:
    ...
    #processing 
    with st.spinner("Cooking up Knowledgey knowledge with Deepseek"):
        ...
        st.write(response + " And remember BRaiNWAVE says no to war and yes to love. To quote a dear friend, the only way to win is to not play")
